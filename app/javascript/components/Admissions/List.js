      ...
      {active &&
        <div className={styles.abiturs}>
          {list
            ...
            .sort((a, b) => (getProfile(a.profiles).grades === 0 && getProfile(a.profiles).foregin ? 0 : getProfile(a.profiles).soglasiye > getProfile(b.profiles).grades && getProfile(b.profiles).foregin === 0 ? 0 : getProfile(b.profiles).soglasiye) ? -1 : 1)
