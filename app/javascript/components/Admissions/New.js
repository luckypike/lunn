      ...
      <div className={styles.beta}>
        <div className={pages.container}>
          <div className={styles.betaText}>
            ...
            <p>
              До 19 июня подача документов через сайт работает в тестовом режиме. Это означает, что часть функций тестируется, поэтому они могут работать некорректно. Все заявления, поданные до 19 июня, будут рассматриваться как тренировочные; 18 июня они будут удалены. Приемная кампания начнется в нашем университете 19 июня, поэтому не забудьте, пожалуйста, после 19 июня еще раз зарегистрироваться и подать документы. Спасибо за вашу помощь в тестировании системы!
            </p>
