      ...
      <div className={styles.beta}>
        <div className={pages.container}>
          <div className={styles.betaText}>
            ...
            <p>
              До 19 июня подача документов через сайт работает в тестовом режиме. Это означает, что часть функций тестируется, поэтому они могут работать некорректно. Все заявления, поданные до 19 июня, не будут удалены и будут считаться полноценными заявлениями о поступлении. Однако обращаем ваше внимание, что после заполнения  всех форм и отправки документов на проверку внести изменения через сайт будет невозможно. Поэтому прежде чем приступить к подаче заявления, убедитесь, пожалуйста, что вы собрали ВСЕ необходимые документы.
            </p>
