      ...
      <div className={styles.program}>
        ...
        {magistracy &&
          <div className={styles.timing}>
            <div className={styles.date}>
              <div>10 августа</div>
              <div>Завершается прием документов, необходимых для поступления</div>
            </div>

            <div className={styles.date}>
              <div>20 августа</div>
              <div>Завершаются вступительные испытания</div>
            </div>
            ...
            <div className={styles.date}>
              <div>24 августа</div>
              <div>Издаются приказы о зачислении абитуриентов, подавших заявление о согласии на зачисление, на бюджетные места</div>
            </div>
