...
export default function Index ({ loaf }) {
  ...
  const arr = [
    ...
    { faculty: 'Факультет международных отношений, экономики и управления', department: 'Кафедра международных отношений и политологии', nid: 586 },
    { faculty: 'Факультет международных отношений, экономики и управления', department: 'Кафедра экономики, управления и информатики', nid: 587 },
    { faculty: 'Факультет романо-германских языков', department: 'Кафедра теории и практики немецкого языка', nid: 613 },
    { faculty: 'Факультет романо-германских языков', department: 'Кафедра теории и практики французского языка', nid: 614 },
